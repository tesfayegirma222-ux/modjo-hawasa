...
def check_password():
    ...
    if "password_correct" not in st.session_state:
        st.markdown("<div style='text-align: center; padding: 20px;'><h2 style='color: #1e3a8a;'>MH Electro Mechanical Asset Portal</h2><p>MH Electromechanical Asset Master Database</p></div>", unsafe_allow_html=True)
...
if check_password():
    AAE_STRUCTURE = {
        ...
        "Illumination System": ["High Mast Light pole", "Road Light pole", "Booth Light 11w", "Plaza Light 250w", "Photocell Controller", "road light led 150w", "compund light 45w", "compound Light pole", "Compound light Globe type cover", "Highh mast light(800w)"],
    ...
    LOCATIONS = ["Modjo", "Koka", "Bote", "Maki", "Batu", "Along roadside", "others"]
