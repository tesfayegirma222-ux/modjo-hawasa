...
if check_password():
    AAE_STRUCTURE = {
        ...
        "Illumination System": ["High Mast Light pole", "Road Light pole", "Booth Light 11w", "Plaza Light 250w", "Photocell Controller", "road light led 150w", "compund light 45w", "compound Light pole"],
